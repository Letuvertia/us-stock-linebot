...
const PROP_KEYS = {
  ...
  CFA_QUESTION_SPREADSHEET_ID: 'CFA_QUESTION_SPREADSHEET_ID',
  CFA_SUMMARY_SPREADSHEET_ID: 'CFA_SUMMARY_SPREADSHEET_ID',
  LINE_CHANNEL_ACCESS_TOKEN: 'LINE_CHANNEL_ACCESS_TOKEN',
  LINE_CHANNEL_SECRET: 'LINE_CHANNEL_SECRET',
  LINE_GROUP_ID: 'LINE_GROUP_ID',
  INSTALL_TRIGGERS_TOKEN: 'INSTALL_TRIGGERS_TOKEN',
  NUO_USER_ID: 'NUO_USER_ID',
  NIU_USER_ID: 'NIU_USER_ID',
} as const;
